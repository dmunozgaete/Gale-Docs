...
.controller('ReportServicesInRangeController', function (
	$scope, 
	$state, 
	$Api, 
	$karmaTable,
	...
	var _changeFilters = function(from,to,type){
		...
		_karmaComponent.setup('/Report/ServicesInRange?from={0}&to={1}&type={2}'.format([
	...
	$scope.export = function(){
		var data = $scope.data;
		var url = $Api.get_endpoint() + '/Printer/ServicesInRange?from={0}&to={1}&type={2}&businessUnit={3}'.format([
