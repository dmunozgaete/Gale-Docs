                ...
                '$scope', function(scope) {
                    ...
                    scope.calendar = {
                        ...
                        offsetMargin: function() {
                            return "" + (new Date(this._year, this._month).getDay() * 2.75) + "rem";
                        },
